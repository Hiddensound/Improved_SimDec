...
public class PlagResult {
	public ArrayList<com.company.com.company.MatchVals> tiles;
	...
	public PlagResult(int id1, int id2){
		this.tiles = new ArrayList<com.company.com.company.MatchVals>();
	 ...
	 * @param tiles
	 */
	public void setTiles(ArrayList<com.company.com.company.MatchVals> tiles){
		if(tiles.getClass() != new ArrayList<com.company.com.company.MatchVals>().getClass())
	 ...
	 * @return tiles
	 */
	public ArrayList<com.company.com.company.MatchVals> getTiles(){
		return this.tiles;
	}
     ...
     * @return identifiers
     */
    public com.company.com.company.Identifiers getIdentifier(){
        if (this.id1 == 0 || this.id2 == 0)
            System.out.println("NoIdentifierSetError: One or both identifier were not set.");
        return (new com.company.com.company.Identifiers(this.id1, this.id2));
    }
     ...
     */
    public com.company.com.company.StringLengths getIdStringLength(){
        return (new com.company.com.company.StringLengths(this.id1StringLength, this.id2StringLength));
    }
