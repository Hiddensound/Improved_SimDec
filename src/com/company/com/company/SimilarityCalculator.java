...
public class SimilarityCalculator {
	 ...
	 */
	public static SimVal calcSimilarity(List<String> s1List, List<String> s2List, ArrayList<com.company.com.company.MatchVals> tiles, float threshold ){
	...
	private static float sim(List<String> s1List,
			List<String> s2List, ArrayList<com.company.com.company.MatchVals> tiles) {
	 ...
	 * @return
	 */
	private static int coverage(ArrayList<com.company.com.company.MatchVals> tiles) {
		int accu = 0;
		for (com.company.com.company.MatchVals tile : tiles){
			accu += tile.length;
		}	
		return accu;
	}
