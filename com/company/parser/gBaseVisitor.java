...
public class gBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements gVisitor<T> {
	 ...
	 */
	@Override public T visitMain(gParser.MainContext ctx) { return visitChildren(ctx); }
	/**
	 * {@inheritDoc}
	 *
	 * <p>The default implementation returns the result of calling
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitName(gParser.NameContext ctx) { return visitChildren(ctx); }
}